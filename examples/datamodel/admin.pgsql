...
CREATE TABLE public.yunyun_menu (
    id integer NOT NULL,
...
CREATE TABLE public.yunyun_operation_log (
    id integer NOT NULL,
...
ALTER TABLE public.yunyun_operation_log ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.yunyun_operation_log_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.yunyun_permissions (
    id integer NOT NULL,
...
ALTER TABLE public.yunyun_permissions_id_seq ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE public.yunyun_permissions_id_seq OWNED BY public.yunyun_permissions.id;


CREATE TABLE public.yunyun_role_menu (
...
CREATE TABLE public.yunyun_role_permissions (
    role_id integer NOT NULL,
...
CREATE TABLE public.yunyun_role_users (
    role_id integer NOT NULL,
    user_id integer NOT NULL,
    created_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP NOT NULL
...
CREATE TABLE public.yunyun_roles (
    id integer NOT NULL,
    name character varying(50) NOT NULL,
    slug character varying(50) NOT NULL,
...
CREATE TABLE public.yunyun_session (
    id integer NOT NULL,
    sid character varying(50) DEFAULT ''::character varying NOT NULL,
    "values" character varying(3000) DEFAULT ''::character varying NOT NULL,
    created_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP NOT NULL
);


ALTER TABLE public.yunyun_session ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.yunyun_session_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.yunyun_users (
    id integer NOT NULL,
...
COPY public.yunyun_menu (id, parent_id, "order", title, icon, uri, created_at, updated_at, type) FROM stdin;
...
COPY public.yunyun_permissions (id, name, slug, http_method, http_path, created_at, updated_at) FROM stdin;
...
COPY public.yunyun_role_menu (role_id, menu_id, created_at, updated_at) FROM stdin;
...
COPY public.yunyun_role_permissions (role_id, permission_id, created_at, updated_at) FROM stdin;
...
COPY public.yunyun_role_users (role_id, user_id, created_at, updated_at) FROM stdin;
1	1	2019-03-18 18:02:02.210694+00	2019-03-18 18:02:02.210694+00
\.


COPY public.yunyun_roles (id, name, slug, created_at, updated_at) FROM stdin;
1	Administrator	administrator	2019-03-18 14:46:43.812101+00	2019-03-18 14:46:43.812101+00
\.


COPY public.yunyun_users (id, username, password, name, avatar, remember_token, created_at, updated_at) FROM stdin;
1	admin	$2a$10$HVJXUQys.QNvncK9gOdSWu63Ue6c9ZQtimBb0nU.ygb7QjmsYhLMO	admin		tlNcBVK9AvfYH7WEnwB1RKvocJu8FfRy4um3DJtwdHuJy0dwFsLOgAc0xUfh	2019-03-18 17:27:38.106738+00	2019-03-18 17:27:38.106738+00
\.


SELECT pg_catalog.setval('public.yunyun_operation_log_id_seq', 12, true);


SELECT pg_catalog.setval('public.yunyun_permissions_id_seq', 1, false);


SELECT pg_catalog.setval('public.yunyun_session_id_seq', 4, true);


ALTER TABLE ONLY public.yunyun_operation_log
    ADD CONSTRAINT yunyun_operation_log_pkey PRIMARY KEY (id);


ALTER TABLE ONLY public.yunyun_session
    ADD CONSTRAINT yunyun_session_pkey PRIMARY KEY (id);
