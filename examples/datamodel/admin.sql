...
INSERT INTO `yunyun_menu` (`id`, `parent_id`, `order`, `title`, `icon`, `uri`, `created_at`, `updated_at`, `type`)
VALUES
...
LOCK TABLES `yunyun_session` WRITE;
/*!40000 ALTER TABLE `yunyun_session` DISABLE KEYS */;

INSERT INTO `yunyun_session` (`id`, `sid`, `values`, `created_at`, `updated_at`)
VALUES
...
/*!40000 ALTER TABLE `yunyun_session` ENABLE KEYS */;
UNLOCK TABLES;
