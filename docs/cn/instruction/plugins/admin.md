...
[上一页：插件的使用](https://github.com/chinlee1523/go-admin/blob/master/docs/cn/instruction/plugins/plugins.md)<br>
[下一页：自定义页面](https://github.com/chinlee1523/go-admin/blob/master/docs/cn/instruction/pages/pages.md)
